...
params_dict = {
    ...
    'numBatch': 100, 'useTensorboard': True,
    'tensorboardParams': {
...
#Averaged_DQN.load("./saved_models/CarRacing_v0/ADQN_lr1e-5.obj")

# TRAIN Agent
Averaged_DQN.train(MAX_EPISODES)

# save model
Averaged_DQN.save("./saved_models/CarRacing_v0/ADQN_lr1e-5.obj")
